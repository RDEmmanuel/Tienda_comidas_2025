                ...
                <form action="{{ route('admin.productos.update', $producto) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-1/2 p-1">
                            ...
                            <x-text-input id="nombre" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                                type="text" name="nombre" :value="old('nombre', $producto->nombre)" required autofocus autocomplete="nombre" />
                    ...
                    <div class="p-1">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4"
                            class="w-full mt-1 rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('descripcion', $producto->descripcion) }}</textarea>
                    </div>

                    <!-- Stock, precio costo y precio venta -->
                    <div class="flex flex-wrap">
                        <div class="w-1/3 p-1">
                            <x-input-label for="stock" :value="__('Stock')" class="dark:text-gray-300" />
                            <x-text-input id="stock" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                                type="text" name="stock" :value="old('stock', $producto->stock)" required />
                        ...
                        <div class="w-1/3 p-1">
                            ...
                            <x-text-input id="precio_costo" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                                type="text" name="precio_costo" :value="old('precio_costo', $producto->precio_costo)" required />
                        ...
                        <div class="w-1/3 p-1">
                            ...
                            <x-text-input id="precio_venta" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                                type="text" name="precio_venta" :value="old('precio_venta', $producto->precio_venta)" required />
                    ...
                    <div class="p-1">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Si selecciona una nueva imagen, reemplazará la actual.</p>
                    </div>
