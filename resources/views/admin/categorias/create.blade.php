        ...
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.categorias.store') }}" method="POST">
                    ...
                    <!-- Descripción -->
                    <div class="p-1">
                        <x-input-label for="descripcion" :value="__('Descripcion')" class="dark:text-gray-300" />
                        <x-text-input id="descripcion" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" type="text" name="descripcion"
                            :value="old('descripcion')" autofocus autocomplete="descripcion" />
